...
@WebFilter(filterName = "UserHdFilter", 
urlPatterns = {"/ServletManageJoin","/ServletManageLike","/ServletManageAr"}, 
initParams = {
...
public class UserActivityFilter implements Filter  {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws java.io.IOException, ServletException {
		...
		boolean isMatch=table.isHasNextResult();
		if(isMatch) {
