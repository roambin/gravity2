...
/**
 * Servlet implementation class ServletFriendMyAsk
 */
@WebServlet("/ServletFriendMyAsk")
public class ServletFriendMyAsk extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletFriendMyAsk() {
        super();
