...
/**
 * Servlet implementation class ServletManageLike
 */
@WebServlet("/ServletManageLike")
public class ServletManageLike extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletManageLike() {
        super();
