...
/**
 * Servlet implementation class ServletFriendMyAdd
 */
@WebServlet("/ServletFriendMyAdd")
public class ServletFriendMyAdd extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletFriendMyAdd() {
        super();
