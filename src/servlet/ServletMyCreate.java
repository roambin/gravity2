...
/**
 * Servlet implementation class ServletMyCreate
 */
@WebServlet("/ServletMyCreate")
public class ServletMyCreate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletMyCreate() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		activity=new ActivityPlusCd(userid,"create");
