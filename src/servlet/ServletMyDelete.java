...
/**
 * Servlet implementation class ServletMyDelete
 */
@WebServlet("/ServletMyDelete")
public class ServletMyDelete extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletMyDelete() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		activity=new ActivityPlusCd(userid,"delete");
