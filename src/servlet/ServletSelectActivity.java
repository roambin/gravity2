...
/**
 * Servlet implementation class ServletSelectActivity
 */
@WebServlet("/ServletSelectActivity")
public class ServletSelectActivity extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletSelectActivity() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userid==null) {
			activity=new ActivityPlusNoid();
		}else {
			activity=new ActivityPlus();
