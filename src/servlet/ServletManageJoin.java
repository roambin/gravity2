...
/**
 * Servlet implementation class ServletManageJoin
 */
@WebServlet("/ServletManageJoin")
public class ServletManageJoin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletManageJoin() {
        super();
